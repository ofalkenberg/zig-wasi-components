...
macro_rules! __export_math_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*:: __export_world_math_cabi!($ty with_types_in
        $($path_to_types_root)*);
    };
}
#[doc(inline)]
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:demo:math@0.1.0:math:encoded world"
)]
#[doc(hidden)]
...
@\x02\x01ay\x01by\0y\x04\0\x03add\x01\0\x04\0\x14demo:math/math@0.1.0\x04\0\x0b\x0a\
\x01\0\x04math\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x07\
